  ...
  return (
    ...
    <nav className="flex items-center justify-between px-6 h-16 py-3 bg-gray-200 shadow-md">
     ...
     <div className="flex items-center space-x-6">
        <Button variant={"ghost"}  className="hover:bg-transparent">Dashboard</Button>
        <Button variant={"ghost"} className="hover:bg-transparent">Subscription</Button>
          <Button variant="ghost"  className="hover:bg-transparent">Search Network</Button>
        <Button variant="ghost"  className="hover:bg-transparenttext ">Analytics</Button>
