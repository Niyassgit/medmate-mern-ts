...
const ProfilePage = () => {
  ...
  const fields = [
    ...
    doctor.opHours,
    doctor.hasOwnClinic,
    doctor.departmentId, // added
    doctor.territoryId, // added
  ];
...
<div className="grid md:grid-cols-2 gap-6">
  ...
  <div className="bg-white rounded-2xl shadow-lg p-6 hover:shadow-xl transition-shadow border border-gray-100">
    ...
    <div className="space-y-3">
      <DetailItem icon="🏥" label="Hospital" value={doctor.hospital || "Not provided"} />
      <DetailItem icon="🏢" label="Own Clinic" value={doctor.hasOwnClinic ? "Yes" : "No"} />
      <DetailItem icon="🆔" label="Registration" value={doctor.registrationId} />
      <DetailItem icon="🏥" label="Department" value={doctor.departmentId || "Not assigned"} />
      <DetailItem icon="📍" label="Territory" value={doctor.territoryId || "Not assigned"} />
      <DetailItem icon="🕐" label="OP Hours" value={doctor.opHours || "Not provided"} />
    </div>
  </div>
    ...
    {doctor.educations?.length ? (
      <div className="space-y-3">
        {doctor.educations.map((edu) => (
          <div key={edu.id} className="p-3 bg-gray-50 rounded-lg border-l-4 border-green-500 hover:bg-gray-100 transition-colors">
      ...
      <p className="text-gray-400 text-center py-4">No education details added</p>
    )}
  </div>
    ...
    {doctor.certificates?.length ? (
      <div className="space-y-3">
        {doctor.certificates.map((cert) => (
          <div key={cert.id} className="p-3 bg-gray-50 rounded-lg border-l-4 border-yellow-500 hover:bg-gray-100 transition-colors">
      ...
      <p className="text-gray-400 text-center py-4">No certificates uploaded</p>
    )}
  </div>
</div>
